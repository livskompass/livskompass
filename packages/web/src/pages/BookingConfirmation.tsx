...
export default function BookingConfirmation() {
  ...
  if (isLoading) {
    return (
      <div className="max-w-2xl mx-auto px-4 py-24 text-center">
        <Loader2 className="h-12 w-12 text-primary-600 animate-spin mx-auto mb-6" />
        <p className="text-gray-500 text-lg">Bekräftar bokning...</p>
      </div>
    )
  }
        ...
        <Card className="text-left mb-8">
          <CardContent className="p-5">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-500 mb-0.5">Bokningsnummer</p>
                <p className="font-mono font-medium text-gray-900">{bookingId}</p>
              </div>
